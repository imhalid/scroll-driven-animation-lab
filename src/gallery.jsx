const Gallery = () => {
  return (
    <div className="w-full h-auto py-10 bg-neutral-900 rounded-xl relative z-0 border border-neutral-700 p-1 flex flex-wrap items-center gap-2 justify-center gallery-wrapper">
      ...
      <div id="img-container" style={{ "--index": 5, "--sat": 2 }}>
        <img
      ...
      <div id="img-container" style={{ "--index": 6, "--sat": 2 }}>
        <img
      ...
      <div id="img-container" style={{ "--index": 7, "--sat": 2 }}>
        <img
      ...
      <div id="img-container" style={{ "--index": 8, "--sat": 2 }}>
        <img
          src="https://images.unsplash.com/photo-1718809070510-371f29994edd?q=80&w=2187&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          width="200"
          height="300"
          className="gallery-images w-[200px] h-[300px] object-cover image4"
        />
